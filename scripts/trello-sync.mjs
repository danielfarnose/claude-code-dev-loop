...
const TYPE_COLORS = { security: "red", bug: "orange", logic: "yellow", feature: "green", cleanup: "sky", copy: "purple" };
const COLORS = ["green", "yellow", "orange", "red", "purple", "blue", "sky", "lime", "pink", "black"];
export const colorForProject = (s) => TYPE_COLORS[s] ?? COLORS[[...s].reduce((a, c) => a + c.charCodeAt(0), 0) % COLORS.length];
