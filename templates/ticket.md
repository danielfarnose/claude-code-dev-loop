...
@architect copies this structure as-is for every ticket it writes. Product first
(understandable without reading code), technical at the end. Readable in <60 seconds — if it
doesn't fit on one screen, the ticket is a candidate for splitting.
